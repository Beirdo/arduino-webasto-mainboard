...
eeprom_data_t eeprom_data[BOARD_COUNT] = {
  ...
  {1, 0, 2, 0x40, 0x32, 0xFF, 0x4A, 0xFF, 0xFF, 0x00000000},  // start/run
  {1, 0, 3, 0x08, 0x33, 0x60, 0xFF, 0xFF, 0xFF, 0x00000000},  // Exhaust temperature
  {1, 0, 4, 0x80, 0xFF, 0xFF, 0xFF, 0xFF, 0x7C. 0x00000000},  // LINBus Bridge
};
void *eeprom_devices[BOARD_COUNT];
