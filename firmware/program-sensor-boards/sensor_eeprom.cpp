...
eeprom_data_t eeprom_data[3] = {
  {1, 0, 0, 0x13, 0x30, 0xFF, 0x48, 0x18},  // External temperature, battery voltage, ignition sense
  {1, 0, 1, 0x04, 0x31, 0xFF, 0x49, 0xFF},  // Coolant temperature
  {1, 0, 2, 0x08, 0x32, 0x60, 0xFF, 0xFF},  // Exhaust temperature
};
