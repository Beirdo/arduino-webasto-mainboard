...
void DS2482Source::init(void)
{
  ...
  if (!_valid){
    // logmsg("DS18B20/DS2482@0x%02X/I2C not configured correctly",_i2c_address");
    return;
  }
...
int32_t DS2482Source::read_device(void)
{
  if (!_valid) {
...
int32_t DS2482Source::convert(int32_t reading)
{
  if (reading != UNUSED_READING) {
